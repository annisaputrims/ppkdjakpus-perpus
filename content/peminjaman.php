            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div align="right" class="mb-3">
                        <a href="?pg=tambah-peminjaman" class="btn btn-primary">Tambah</a> <!-- href=link nya menuju kemana -->
                    </div>
                        ...
                        <tbody style="text-align: center;">
                            ...
                            while ($rowPinjam = mysqli_fetch_assoc($queryPinjam)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?pg=tambah-peminjaman&detail=<?php echo $rowPinjam['id'] ?>" class="btn btn-sm btn-primary">Detail</a>
                                        <a href="?pg=tambah-peminjaman&delete=<?php echo $rowPinjam['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin akan menghapus data?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
