...
if (isset($_GET['detail'])) {
    //DATA PEMINJAM
    $id = $_GET['detail'];
    $Detail = mysqli_query($koneksi, "SELECT anggota.nama_lengkap as nama_anggota, peminjaman.*, user.nama_lengkap FROM peminjaman LEFT JOIN anggota ON anggota.id = peminjaman.id_anggota LEFT JOIN user ON user.id WHERE peminjaman.id = '$id'");
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-6">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8"> <?php echo  $interval->days . " hari" ?> </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="row mb-3">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="kode_transaksi" class="form-control" value="<?php echo ($kode_transaksi ?? '') ?>" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-2">
